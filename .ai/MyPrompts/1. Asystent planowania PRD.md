...
<project_description>
### Główny problem
Manualne tworzenie wysokiej jakości fiszek edukacyjnych jest czasochłonne, co zniechęca do zgłębiania wiedzy na konkretne tematy.

### Najmniejszy zestaw funkcjonalności
- Generowanie fiszek przez AI na podstawie wprowadzonej listy interesujących tematów
- Manualne tworzenie fiszek dla danego tematu
- Możliwość stworzenia kolekcji (np. Sport, Motoryzacja) i tematu przypisanego do kolekcji (np. dla kolekccji Sport, stworzenie tematów: |Piłka Nożna|, |Piłka Siatkowa|)
- Aplikacja zawiera domyślną kategorię o nazwie ,,Kolekcja losowa", ta kolekcja z kolei zawiera temat ,,Temat losowy" w którym możemy wygenerować losową ciekawostkę na temat wybrany przez AI.
